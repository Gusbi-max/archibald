...
<body>
  <header class="row">
      <div class="row logo">
         <img class="archibald" src="<?= get_template_directory_uri() . '/assets/images/logo_archibald.png' ?>" alt="archibald">
      </div>
      <div class="row lines">
      ...
      <div class="row button-basket">
        <svg id="Logo_panier" data-name="Logo panier" xmlns="http://www.w3.org/2000/svg" width="30.752" height="20.65" viewBox="0 0 30.752 20.65">
      ...
      <div class="row button-profil">
         <svg class="basket" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="37" height="37" viewBox="0 0 37 37">
